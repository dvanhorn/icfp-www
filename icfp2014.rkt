  ...
  (make-page
   ...
   `(div
     ...
     (dl (dt "8:45-9:00 Opening (General Chair)")
         ...
         (dd "Using Formal Methods to Enable More Secure Vehicles: DARPA's HACMS Program")
         (dt "10:00-10:30 Coffee")
         (dt ((class "session")) "10:30-11:20 Session 1: Domain Specific Languages I")
         (dt ((class "paper")) (em "Building Embedded Systems with Embedded DSLs (Experience Report)"))
         ...
         (dt ((class "paper")) (em "Concurrent NetCore: From Policies to Pipelines"))
         ...
         (dt ((class "paper")) (em "SeLINQ: Information Flow in Databases for Free"))
         (dd ((class "paper")) "Daniel Schoepe (Chalmers University of Technology); Andrei Sabelfeld (Chalmers University of Technology); Daniel Hedin (Chalmers University of Technology)")
         (dt ((class "paper")) (em "Type-Based Parametric Analysis of Program Families"))
         ...
         (dt ((class "paper")) (em "Romeo: A System for More Flexible Binding-Safe Programming"))
         (dd ((class "paper")) "Paul Stansifer (Northeastern University);Mitchell Wand (Northeastern University)")
         (dt ((class "paper")) (em "Maximal Sharing in the Lambda Calculus with letrec"))
	 ...
	 (dt ((class "paper")) (em "Practical and Effective Higher-Order Optimizations"))
	 ...
	 (dt ((class "paper")) (em "Worker/Wrapper/Makes It/Faster"))
	 ...
	 (dt ((class "paper")) (em "Compositional Semantics for Composable Continuations: From Abortive to Delimited Control"))
	 ...
	 (dt ((class "paper")) (em "Soft Contract Verification"))
	 ...
	 (dt ((class "paper")) (em "On Teaching " (bold "How to Design Programs") ": Observations from a Newcomer"))
	 (dd ((class "paper")) "Norman Ramsey (Tufts University)")
	 (dt "11:20-11:40 Break")
	 (dt ((class "session")) "11:40-12:30 Session 7: Tools Used in Anger")
	 (dt ((class "paper")) (em "SML# in Industry: A Practical ERP System Development (Experience Report)"))
	 ...
	 (dt ((class "paper")) (em "Lem: Reusable Engineering of Real-World Semantics"))
	 ...
	 (dt ((class "paper")) (em "Safe Zero-Cost Coercions for Haskell"))
	 ...
	 (dt ((class "paper")) (em "Hindley-Milner Elaboration in Applicative Style (Functional Pearl)"))
	 (dd ((class "paper")) "Francois Pottier (INRIA)")
	 (dt "14:50-15:10 Break")
	 (dt ((class "session")) "15:10-16:00 Session 9: Incremental Computing")
	 (dt ((class "paper")) (em "Settable and Non-Interfering Signal Functions for FRP"))
	 (dd ((class "paper")) "Daniel Winograd-Cort (Yale University); Paul Hudak (Yale University)")
	 (dt ((class "paper")) (em "Functional Programming for Dynamic and Large Data with Self-Adjusting Computation"))
	 ...
	 (dt ((class "paper")) (em "Homotopical Patch Theory"))
	 ...
	 (dt ((class "paper")) (em "Pattern Matching without K"))
	 ...
	 (dt ((class "paper")) (em "Refinement Types For Haskell"))
	 ...
	 (dt ((class "paper")) (em "A Theory of Gradual Effect Systems"))
	 ...
	 (dt ((class "paper")) (em "How to Keep Your Neighbours in Order"))
	 (dd ((class "paper")) "Conor McBride (University of Strathclyde)")
	 (dt ((class "paper")) (em "A Relational Framework for Higher-Order Shape Analysis"))
	 ...
	 (dt ((class "paper")) (em "There is no Fork: an Abstraction for Efficient, Concurrent, and Concise Data Access"))
	 (dd ((class "paper")) "Simon Marlow (Facebook); Louis Brandy (Facebook); Jonathan Coens (Facebook); Jon Purdy (Facebook)")
	 (dt ((class "paper")) (em "Folding Domain-Specific Languages: Deep and Shallow Embeddings (Functional Pearl)"))
	 ...
	 (dt ((class "paper")) (em "Krivine Nets"))
