  ...
  (make-page
   ...
   `(div
     ...
     (dl (dt ((class "keynotetitle")) "9:00 Keynote: Ulf Norell (Chair: Tarmo Uustalu)")
         ...
         (dt "10:00 Break")
         (dt ((class "session")) "10:20 Session 1: Verification with Grammars and Automata (Chair: David Van Horn)")
	 ...
	 (dt "10:00 Break")
	 (dt ((class "session")) "10:20 Session 6: Concurrency (Chair: Manuel Chakravarty)")
	 ...
	 (dt "10:00 Break")
	 (dt ((class "session")) "10:20 Session 11: Modular Meta-Theory (Chair: Zhenjiang Hu)")
