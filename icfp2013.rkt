...
(define program.xexpr
  (make-page
   ...
   `(div
     ...
     (dl (dt ((class "keynotetitle")) "9:00 Keynote: Ulf Norell")
         (dd "Interactive Programming with Dependent Types")
         (dt "10:00 Break")
         (dt ((class "session")) "10:20 Session 1: Verification with Grammars and Automata")
         ...
         (dt "11:00 Break")
         (dt ((class "session")) "11:30 Session 2")
         ...
         (dt "12:30 Lunch")
         (dt ((class "session")) "14:00 Session 3: Dependent Types")
	 ...
	 (dt "15:00 Break")
         (dt ((class "session")) "15:30 Session 4: Fun in the Afternoon")
	 ...
	 (dt "16:30 Break")
	 (dt ((class "session")) "17:00 Session 5: Handling Effects")
     ...
     (dl (dt ((class "keynotetitle")) "9:00 Keynote: Simon Peyton Jones")
         (dd "Computer Science as a School Subject")
	 (dt "10:00 Break")
	 (dt ((class "session")) "10:20 Session 6: Concurrency")
	 ...
	 (dt "11:00 Break")
	 (dt ((class "session")) "11:30 Session 7: (Co-)Recursion")
	 ...
	 (dt "12:30 Lunch")
	 (dt ((class "session")) "14:00 Session 8: Functional Reactive Programming")
	 ...
	 (dt "15:00 Break")
	 (dt ((class "session")) "15:30 Session 9: Lambda-Calculus")
     ...
     (dl (dt ((class "session")) "Session 10: Monads")
	 ...
	 (dt "10:00 Break")
	 (dt ((class "session")) "Session 11: Modular Meta-Theory")
	 ...
	 (dt "12:30 Lunch")
	 (dt ((class "session")) "14:00 Session 13: Program Logics")
	 (dt ((class "paper")) (em "Hoare-Style Reasoning with (Algebraic) Continuations"))
	 (dd ((class "paper")) "GermÃ¡n Andr" eacute "s Delbianco and Aleksandar Nanevski")
	 ...
	 (dt "15:00 Break")
	 (dt ((class "session")) "15:30 Session 14: Language Design")
	 ...
	 (dt "16:30 Break")
	 (dt ((class "session")) "17:00 Session 15: Analysis and Optimization")
  ...
  (make-page 
   ...
   `(div
	...
	" Logan International Airport is centrally located in the City of Boston -- Downtown Boston"
     ...
     (h3 "Alternative hotels and hostels")
     (p "Less Expensive hotels found on Expedia.com With Free airport shuttle service:")
     (ul (li "Hotel in Malden, MA " ndash " $109/night" (br)
	     "Econo Lodge" (br)
	     "321 Broadway, Malden, MA, US, 02148" (br)
	     "Phone: (781) 324-8500" (br)
	     (a ((href "http://www.econolodge.com/hotel-malden-massachusetts-MA080")) "http://www.econolodge.com/hotel-malden-massachusetts-MA080"))
	 (li "Hotel in Revere MA " ndash "$139/night" (br)
	     "Comfort Inn & Suites Logan International Airport" (br)
	     "85 American Legion Hwy." (br)
	     "Revere, MA, US, 02151" (br)
	     "Free Airport Shuttle, Free Breakfast, Free Internet, Fitness Center" (br)
	     (a ((href "http://comfortinnboston.com/bostonhotelsloganinternationalairporthotels.htm")) "http://comfortinnboston.com/bostonhotelsloganinternationalairporthotels.htm"))
	 (li "Hotel in Revere MA " ndash "$132/night" (br)
	     "Four Points By Sheraton Boston Logan International Airport" (br)
	     "407 Squire Road, Revere, MA" (br)
	     "Phone: (781) 284-7200" (br)
	     (a ((href "http://www.starwoodhotels.com/fourpoints/property/overview/index.html?propertyID=1141"))
		"http://www.starwoodhotels.com/fourpoints/property/overview/index.html?propertyID=1141"))
	 (li "Hotel in Somerville, MA " ndash " $159/night" (br)
	     "La Quinta Inn & Suites Boston-Somerville" (br)
	     "23 Cummings St Somerville, MA 02145" (br)
	     "Phone: (617) 625-5300" (br)
	     (a ((href "http://www.laquintabostonsomerville.com/")) "http://www.laquintabostonsomerville.com/"))
	 (li "Hotel in Winthrop, MA " ndash " $149/night" (br)
	     "Suburban Extended Stay Logan Airport" (br)
	     "312 Shirley Street, Winthrop, MA, US, 02152" (br)
	     "Includes: Free Parking, Free Wireless Internet, Free Airport Shuttle" (br)
	     "Phone: (617) 539-9466" (br)
	     (a ((href "http://www.suburbanhotels.com/hotel-winthrop-massachusetts-MA164?listpos=1"))
		"http://www.suburbanhotels.com/hotel-winthrop-massachusetts-MA164?listpos=1"))
	 (li "Hotels in Quincy MA " ndash " approx. $150/night" (br)
	     "Best Western Adams Inn" (br)
	     "29 Hancock Street" (br)
	     "Quincy, Massachusetts, 02171-1707, United States" (br)
	     "Phone: (617) 328-1500" (br)
	     (a ((href "http://book.bestwestern.com/bestwestern/selectRoom.do;jsessionid=OcYthqeH3VnHLKI EZlFTOw__.b422c"))
		"http://book.bestwestern.com/bestwestern/selectRoom.do;jsessionid=OcYthqeH3VnHLKI EZlFTOw__.b422c")))
     (p "Bed & Breakfasts in Cambridge, MA:")
     (ul (li "Irving House" (br)
	     "24 Irving Street" (br)
	     "Cambridge MA 02138" (br)
	     "Phone: (617) 547-4600" (br)
	     (a ((href "http://irvinghouse.com/reservations/")) 
		"http://irvinghouse.com/reservations/") (br)
	     "Single bed/shared bath $135" (br)
	     "2 single beds/shared bath $150" (br)
	     "Full size bed/private bath $165" (br)
	     "Queen size/private bath $175 2 people: $190")
	 (li "Harding House " ndash " $150/night only available Sept 22 " ndash " Sept 24 228 Harvard Street" (br)
	     "Cambridge, MA 02139" (br)
	     "Phone: (617)876-2888" (br)
	     "Toll Free: (877) 489-2888" (br)
	     (a ((href "http://www.harding-house.com/"))
		"http://www.harding-house.com/")))
     (p "Hostels in the Boston area:")
     (ul (li "40 Berkeley Hostel" (br)
	     "40 Berkeley Street, Boston MA" (br)
	     "Phone: (617) 375-2524" (br)
	     "Standard singles $85/night Standard doubles $108.67/night" (br)
	     (a ((href "http://www.40berkeley.com/"))
		"http://www.40berkeley.com/"))
	 (li "Hostelling International - Boston" (br)
	     "19 Stuart St., Boston, MA 02116 (Downtown)"
	     "Phone: (617) 536-9455"
	     "$92/night and up"
	     (a ((href "http://bostonhostel.org/contact/"))
		"http://bostonhostel.org/contact/")))	        	
